...
set PATH=%PATH%;%ANDROID_HOME%;%ANDROID_HOME%\platform-tools
set java_exe=
...
call "%java_exe%" -Xmx512m "-Djava.ext.dirs=%frameworkdir%;%swt_path%" -Dcom.android.monkeyrunner.bindir=..\framework -Djava.net.preferIPv4Stack=true -Dfile.encoding=UTF-8 -jar %jarpath% %*
